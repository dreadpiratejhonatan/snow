export const CONFIG = {
  ...
  enemies: {
    ...
    // Robertson: velho bravo — briga com todo mundo (NPCs + jogador)
    robertson: {
      label: "Robertson",
      hp: 95,
      wanderSpeed: 1.6,
      ...
      faction: "chaos",
      drops: [
        { weaponId: "axe", chance: 1, name: "Machado do Robertson", color: 0xb0b8c2 },
        { weaponId: "revolver", chance: 0.85, name: "Revólver", color: 0xd8c25a },
        { ammoType: "bullet", amount: [3, 5], chance: 1, name: "Balas", color: 0xd8c25a },
        { trapId: "bait", chance: 0.6, amount: 1, name: "Isca", color: 0xc87840 },
      ],
    },
    ptero: {
  ...
  skinOrder: ["natan", "jorge", "caio", "lorenzo", "ze", "robertson"],
