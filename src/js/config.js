export const CONFIG = {
  ...
  trapPlaceMaxDist: 35,
  trapPickups: [
    { name: "Mina", color: 0x6a6a6a, trapId: "mine", amount: 1, nearBase: true },
    { name: "Mina", color: 0x6a6a6a, trapId: "mine", amount: 1, midRing: true },
    { name: "Mina", color: 0x6a6a6a, trapId: "mine", amount: 1 },
    { name: "Isca de carne", color: 0xc87840, trapId: "bait", amount: 1, midRing: true },
    { name: "Isca de carne", color: 0xc87840, trapId: "bait", amount: 1 },
    { name: "Cerca improvisada", color: 0x8a6a40, trapId: "fence", amount: 1, midRing: true },
    { name: "Cerca improvisada", color: 0x8a6a40, trapId: "fence", amount: 1 },
  ],
  /** Poções / kit de cura (não contam para vitória). */
  healPickups: [
    { name: "Poção de vida", color: 0xc42838, healthHeal: 40, midRing: true },
    { name: "Poção de vida", color: 0xc42838, healthHeal: 40 },
    { name: "Poção menor", color: 0xe05060, healthHeal: 25, nearBase: true },
    { name: "Poção menor", color: 0xe05060, healthHeal: 25, midRing: true },
    { name: "Kit médico", color: 0xe8e8f0, healthHeal: 55, midRing: true },
  ...
  weapons: {
    ...
    torch: {
      ...
      slowElite: 2.2,
      skinColor: 0xff9a3c,
      /** Segurar na mão aquece; combustível finito (~40s) → puff e some. */
      fuelDuration: 40,
      warmthRegen: 14,
      desc: "Aquece na mão · ~40s · puff e some",
    },
    claymore: {
      id: "claymore",
      name: "Claymore",
  ...
  // pickups de arma — kit inicial enxuto na base; o resto no anel médio
  weaponPickups: [
    ...
    { name: "Tocha reserva", color: 0xffb060, weaponId: "torch", midRing: true, essential: true },
    { name: "Claymore enferrujada", color: 0xb8c8d8, weaponId: "claymore", midRing: true },
    { name: "Arco de caçador", color: 0x9be07a, weaponId: "bow", ammoType: "arrow", amount: 5, midRing: true },
    { name: "Revólver antigo", color: 0xd8c25a, weaponId: "revolver", ammoType: "bullet", amount: 6, midRing: true },
    { name: "Escopeta", color: 0xb87848, weaponId: "shotgun", ammoType: "shell", amount: 3, midRing: true },
  ...
  // munição — só um pacote inicial perto; resto exige explorar
  ammoPickups: [
    { name: "Flechas (+arco)", color: 0x9be07a, ammoType: "arrow", amount: 5, midRing: true },
    { name: "Balas (+revólver)", color: 0xd8c25a, ammoType: "bullet", amount: 6, midRing: true },
    { name: "Cartuchos (+escopeta)", color: 0xe08a5a, ammoType: "shell", amount: 2, midRing: true },
    { name: "Granada", color: 0x5a7a4a, weaponId: "grenade", ammoType: "grenade", amount: 1, midRing: true },
    { name: "Flechas extras", color: 0x7bc86a, ammoType: "arrow", amount: 4 },
    { name: "Balas extras", color: 0xc8b050, ammoType: "bullet", amount: 5 },
    { name: "Granada de reserva", color: 0x4a6a3a, weaponId: "grenade", ammoType: "grenade", amount: 1 },
  ],
  // itens de sobrevivência (+ troféu do urso alfa)
  items: [
    { name: "Lanterna antiga", color: 0xffd75a, midRing: true },
    { name: "Manta térmica", color: 0xc8a070, nearBase: true },
    { name: "Botas de neve", color: 0x3a4a5a, midRing: true },
    { name: "Mapa rasgado", color: 0xd8c49a, midRing: true },
    { name: "Bússola", color: 0x7ad0ff, midRing: true },
    { name: "Machado", color: 0xb0b8c2, weaponId: "axe", midRing: true, essential: true },
    { name: "Latas de comida", color: 0x9ce09c, midRing: true },
    { name: "Corda", color: 0xd9a066 },
    { name: "Isqueiro", color: 0xff9a3c, midRing: true },
    { name: "Rádio", color: 0xb28aff },
    { name: "Garrafa térmica", color: 0x5a8aaa, midRing: true },
    { name: "Binóculos", color: 0x4a5568 },
